...
def main():
    ...
    while True:
        try:
            ...
            print("=== Customer Information (Calculating risk tolerance) ===")
            age = get_float_input("Enter your age (20-60): ", min_val=0, max_val=120)
            income = get_float_input("Enter your monthly income (0-15000 USD): ", min_val=0)
            experience = get_float_input("Enter your investment experience (0-10):", min_val=0)

            # Risk Tolerance Calculation and Visualization
            risk_tolerance_calculator = RiskToleranceCalculator()
            risk_tolerance = risk_tolerance_calculator.calculate_risk_tolerance(age, income, experience)
